...
const file_api_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x16api/user/v1/user.proto\x12\auser.v1\x1a#third_party/validate/validate.proto\"I\n" +
	...
	"\vUserService\x12;\n" +
	"\x06SignIn\x12\x16.user.v1.SignInRequest\x1a\x17.user.v1.SignInResponse\"\x00B\x90\x01\n" +
	"\vcom.user.v1B\tUserProtoP\x01Z9github.com/lens077/go-connect-template/api/user/v1;userv1\xa2\x02\x03UXX\xaa\x02\aUser.V1\xca\x02\aUser\\V1\xe2\x02\x13User\\V1\\GPBMetadata\xea\x02\bUser::V1b\x06proto3"
